...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    NamedCommands.registerCommand("Intake 2s", manipulator.intake().withTimeout(2));
    NamedCommands.registerCommand("Intake 5s", manipulator.intake().withTimeout(5.5));
    NamedCommands.registerCommand("Shoot 6s", manipulator.launch().withTimeout(6));
    NamedCommands.registerCommand("Shoot 9s", manipulator.launch().withTimeout(9));
    NamedCommands.registerCommand(
        "AutoAlign 6s", new AutoAlign3(drive, manipulator, () -> 0, () -> 0).withTimeout(6));
    NamedCommands.registerCommand(
        "AutoAlign 9s", new AutoAlign3(drive, manipulator, () -> 0, () -> 0).withTimeout(9));
