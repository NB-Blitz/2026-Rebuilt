...
public class OppRobotSim extends SubsystemBase {
    ...
    public static final OppRobotSim[] instances = new OppRobotSim[(int)(Double.POSITIVE_INFINITY)]; // you can create as many opponent robots as you needs

    private static final DriveTrainSimulationConfig DRIVETRAIN_CONFIG = null;
