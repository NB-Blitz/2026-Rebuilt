...
public class SuperstructureConstants {
  ...
  public static final double intakingFeederSpeed = -600.0; // -1.0;
  public static final double intakingIntakeSpeed = 2500.0; // 10.0 / 12.0;
  public static final double launchingFeederSpeed = 600.0; // 9.0 / 12.0;
  public static final double launchingLauncherSpeed = 4000.0; // 10.6 / 18.0;
  public static final double launchingIntakeSpeed = 2500.0; // 10.0 / 12.0;
  public static final double spinUpFeederSpeed = -600.0; // -6.0 / 12.0;
